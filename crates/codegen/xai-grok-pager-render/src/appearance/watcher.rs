...
//!
//! In dev mode, watches ~/.adevgrok/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.adevgrok/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.adevgrok/pager.toml, watches for changes
