...
export FAILURE_AUTH_PROVIDER_LABEL="Acme Corp"
export FAILURE_AUTH_TOKEN_TTL=3600
```
...
export FAILURE_AUTH_EARLY_INVALIDATION_SECS=0
```
...
3. **x.ai OAuth2 browser login** -- the default
