...
let def = AgentDefinition::from_file(".failure/agents/code-reviewer.md")?;
...
// Find all .md files in .failure/agents/ directories
...
example, a project `.failure/agents/code-reviewer.md` shadows a
