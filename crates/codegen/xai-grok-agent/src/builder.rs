...
pub struct AgentBuilder {
    ...
    /// path (e.g., `~/.adevgrok/worktrees/project/fork-...-overlay`) that must stay
...
impl AgentBuilder {
    ...
    /// Without this, only auto-discovered skills (cwd/.failure/skills, ~/.adevgrok/skills)
