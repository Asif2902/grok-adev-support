...
//!   under `~/.adevgrok/worktree_pool/<instance_id>/` with a `.pid` liveness
...
/// `~/.adevgrok/worktree_pool/<instance_id>/` with a `.pid` file recording
...
impl WorktreePool {
    ...
    /// `~/.adevgrok/worktree_pool/<instance_id>/`. A `.pid` file is written so
...
pub struct AdoptableWorktree {
    /// Current path: `~/.adevgrok/worktree_pool/<old_instance>/<pool_id>/`
...
/// `~/.adevgrok/worktree_pool/`, reads each `.pid` file, and checks
...
/// The base pool directory under `~/.adevgrok/`.
...
/// `CleanAll` mode. Placed under `~/.adevgrok/worktree_pool/<instance_id>/<uuid>/`.
